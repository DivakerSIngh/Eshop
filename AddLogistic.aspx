<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLogistic.aspx.cs" Inherits="AddLogistic" Title="Add Logistic"%>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                        <asp:TextBox ID="txtLTitle" class="form-control1" placeholder="Enter Tile" runat="server"></asp:TextBox>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
                  <asp:TextBox ID="txtLPincode" CssClass="text-primary" runat="server"></asp:TextBox>
										<asp:Button ID="btnPincodeShift" CssClass="btn-primary" runat="server" Text="Add" OnClick="btnPincodeShift_Click" />
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
                                        <asp:ListBox ID="lbPincodeList" CssClass="list-inline" runat="server" Height="150px" Width="667.5px"></asp:ListBox>
