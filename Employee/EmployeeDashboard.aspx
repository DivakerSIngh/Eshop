     ...
     <script>
        ...
        'jul', 'aug', 'sep', 'oct', 'nov', 'dec'];
         ...
         app.controller('myCtrl', function ($scope, $http) {
            ...
            common.httpPost("EmployeeDashboard.aspx/getDashBoardBudgeCount", '{}', false, success = function (data) {
            ...
            $scope.chartData = function () {
                common.httpPost("EmployeeDashboard.aspx/getSaleReportForRetailer", "{'year':'" + 2018 + "','action':'4'}", false, success = function (data) {
                    $scope.model = data;
