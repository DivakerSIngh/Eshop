                    ...
                    <asp:DataList ID="dlProdInfo" runat="server" RepeatDirection="Horizontal" CellPadding="10" CellSpacing="6" OnItemDataBound="dlProdInfo_ItemDataBound">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblcid" runat="server" Text='<%# Eval("cid") %>' Visible="false"></asp:Label>
                                <asp:LinkButton ID="btnAddCart" ClientIDMode="Static"  class="w3ls-cart" runat="server" CommandArgument='<%# Eval("pid")+","+Eval("UserId")+","+Eval("sellingprice")+","+Eval("costprice") %>' OnCommand="btnAddCart_Command1" ><i class="fa fa-cart-plus" aria-hidden="true"></i>Add to cart</asp:LinkButton>
